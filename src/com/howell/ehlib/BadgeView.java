...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_TOP_MARGIN_DIP = 5;
	private static final int DEFAULT_LR_PADDING_DIP = 8;
	private static final int DEFAULT_TOP_PADDING_DIP = 1;
	...
	private void init(Context context, View target, int tabIndex) {
		...
		int width = PhoneConfig.getPhoneWidth(context);//��Ļ���
		...
		int paddingTopPixels = dipToPixels(DEFAULT_TOP_PADDING_DIP);
		setPadding(paddingPixels, paddingTopPixels, 0, 0);
	...
	public void toggle(boolean animate) {
		toggle(animate, fadeIn, fadeOut,3);
	}
	...
	private void show(boolean animate, Animation anim) {
		if (getBackground() == null) {
			if (badgeBg == null) {
				...
				badgeBg = getResources().getDrawable(R.drawable.new_version);
				//badgeBg.setBounds(0, 0, badgeBg.getIntrinsicWidth()/2, badgeBg.getIntrinsicHeight()/2);
			}
	...
	private void toggle(boolean animate, Animation animIn, Animation animOut,int num) {
		if (num == 0) {
	...
	private void applyLayoutParams() {
		...
		case POSITION_TOP_RIGHT:
			...
			lp.setMargins(0, badgeTopMargin, badgeRightMargin - 20, 0);
